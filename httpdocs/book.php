<?php
        ...
        $conn = mysqli_connect("79.170.44.122", 'cl28-pkb-books', 'x7z.!Fqtz', 'cl28-pkb-books');
        if(!$conn) {
...
<body id="page-top">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <p style="text-align: justify; justify-content: center;"><?php echo $row[introduction]; ?></p>
                <p><strong>Publisher :</strong> <?php echo $row[publisher]; ?></p>
                <p><strong>First Published :</strong> <?php echo $row[first_published]; ?></p>
                
                    <br>
                <a id="button" class="btn btn-lg" target="_blank" href="<?php echo $row[link]; ?>">Buy Book <span class="glyphicon glyphicon-chevron-right"></span></a>
                <a id="buttonx" class="btn btn-lg" style="display: none;"target="_blank" disabled>Buy Book <span class="glyphicon glyphicon-chevron-right"></span></a>
                </font>
            </div>
        ...
        <font size="4">
        <section style="text-align: justify; justify-content: center;">
    ...
    <script>
     ...
     var data = document.getElementById("button").getAttribute("href");
